...
public class CreateUserServiceImpl implements CreateUserService {
    ...
    /** 随机生成非国密公私钥对 */
    private CryptoKeyPair cryptoKeyPair = cryptoSuite.getCryptoKeyPair();
    /** 获取账户地址 */
    private String accountAddress = cryptoKeyPair.getAddress();

    @Override
    public String getUserHash() {
        StringBuilder pemFilePath = new StringBuilder();
        //pemFilePath.append("src/main/resources/solidity/pem/"+accountAddress+".pem");
        pemFilePath.append("C:\\Users\\谢金桥\\Desktop\\luanLai\\src\\main\\resources\\solidity\\pem\\"+
                accountAddress+".pem");

        saveAccountWithPem(cryptoKeyPair,pemFilePath.toString());
        //loadPemAccount(FiscoInitializer.theGetBcosSDK().getClient(),pemFilePath.toString());
